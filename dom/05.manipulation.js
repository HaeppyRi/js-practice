...
//현재방식
document.body.insertAdjacentHTML('beforeend','3');
...
const h1 = getNode('h1');
const template = '<li class="list">도히님 마이크 켜주세요~</li>'

h1.insertAdjacentHTML('afterbegin','<list class="list">도히님 마이크 켜주세요~</list>')
